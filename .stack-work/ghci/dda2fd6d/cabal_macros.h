...
/* package hasklearn-0.1.0.0 */
#ifndef VERSION_hasklearn
#define VERSION_hasklearn "0.1.0.0"
#endif /* VERSION_hasklearn */
#ifndef MIN_VERSION_hasklearn
#define MIN_VERSION_hasklearn(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hasklearn */
...
#define CURRENT_COMPONENT_ID "hasklearn-0.1.0.0-LrBGaPveQNj6lBc13uy3VD-hasklearn"
